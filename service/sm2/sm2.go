...
// reParens matches a parenthesized segment — ASCII () or fullwidth （） — (no
// nested parens) and any surrounding whitespace. Applied iteratively so that
// nested parens are stripped inside-out.
