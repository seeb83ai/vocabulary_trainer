...
type QuizStore interface {
	...
	NextSentenceBlankCard(ctx context.Context, userID int64, cfg models.ProgressiveModeConfig, nwCfg models.NewWordModeConfig, langs []string, tags []string) (*models.QuizCard, error)
}
...
type ComponentStore interface {
	...
	IsComponentForUser(ctx context.Context, userID int64, text string) (bool, error)
	...
	GetComponentCoverage(ctx context.Context, userID int64) ([]ComponentCoverageComponent, map[int64]int, int, map[string]bool, error)
