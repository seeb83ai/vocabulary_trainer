...
const I18N = {
  en: {
    ...
    'issue.screenshotType': 'Screenshot area',
    'issue.screenshotVisible': 'Visible area (default)',
    'issue.screenshotFull': 'Whole page',
    'issue.cancel': 'Cancel',
    'issue.submit': 'Submit',
  ...
  zh: {
    ...
    'issue.screenshotType': '截图区域',
    'issue.screenshotVisible': '可见区域（默认）',
    'issue.screenshotFull': '整页',
    'issue.cancel': '取消',
    'issue.submit': '提交',
